...
#./writeConfig.sh /hadoop/cms/store/user/fgolf/CMS2_V05-03-23/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext1-v1/ ${TAG}_ttsemilep1
#./writeConfig.sh /hadoop/cms/store/user/fgolf/CMS2_V05-03-23/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext2-v1/ ${TAG}_ttsemilep2
./writeConfig.sh /hadoop/cms/store/user/fgolf/CMS2_V05-03-23/QCD_Pt_20_MuEnrichedPt_15_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v3/ ${TAG}_qcdmuenriched
